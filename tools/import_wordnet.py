#!/usr/bin/env python3
"""Convert OMW/WordNet tab files or plain word lists to Hangman ASCII words."""
...
def import_words(
    ...
    for path in paths:
        ...
        for candidate in candidates:
            ...
            # lemmas.  Folding those to lowercase creates bogus Hangman words.
...
def main() -> None:
    ...
    header = (
        f"# {args.language} Hangman words imported from OMW/WordNet.\n"
